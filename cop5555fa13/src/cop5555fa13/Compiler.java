...
public class Compiler {
	...
	public static class CompilerErrorException extends Exception {
		public CompilerErrorException (String msg) {
			super(msg);
		}
	}
	...
	public static void main(String[] args) throws Exception  {
		...
		f.close();
			...
			System.out.println("Compiler error: "+e.getClass()+ e.getMessage());
			return;
		}
